...
schemaDefinition
AtcgGeneratorSchema subschemaOf ErewhonViewSchema completeDefinition, patchVersion=1114, patchVersioningEnabled = true;
...
localeDefinitions
	...
	setModifiedTimeStamp "<unknown>" "" 2024:06:12:11:22:19;
libraryDefinitions
	"jetsupp";
	setModifiedTimeStamp "<unknown>" "6.2.16" 1114 2017:10:09:16:20:19;
	"kernel32";
...
typeHeaders
	AtcgCommon subclassOf JadeDotNetType abstract, transient, number = 2081;
	AtcgAPI subclassOf AtcgCommon transient, sharedTransientAllowed, transientAllowed, subclassSharedTransientAllowed, subclassTransientAllowed, highestOrdinal = 4, number = 2082;
	AtcgGeneratorSchemaApp subclassOf ErewhonViewSchemaApp transient, sharedTransientAllowed, transientAllowed, subclassSharedTransientAllowed, subclassTransientAllowed, highestSubId = 8, highestOrdinal = 51, number = 3914;
	...
	AtcgProfile subclassOf Object transient, subclassSharedTransientAllowed, subclassTransientAllowed, highestOrdinal = 5, number = 2083;
	GAtcgGeneratorSchema subclassOf ErewhonViewSchemaGlobal transient, sharedTransientAllowed, transientAllowed, subclassSharedTransientAllowed, subclassTransientAllowed, highestSubId = 1, highestOrdinal = 3, number = 5518;
	SAtcgGeneratorSchema subclassOf ErewhonViewSchemaSession transient, number = 5523;
...
typeDefinitions
	...
	AtcgCommon completeDefinition
	(
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:18:39.004;
	constantDefinitions
		AssemblyName:                  String = "AtcgCommon, Version=1.3.1.0, Culture=neutral, PublicKeyToken=null" number = 1001;
		setModifiedTimeStamp "<unknown>" "" 2023:06:13:11:18:39;
	)
	AtcgAPI completeDefinition
	(
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:18:39.014;
	constantDefinitions
		AtcgAPITypeName:               String = "AtcgCommon.AtcgAPI" number = 1001;
		setModifiedTimeStamp "<unknown>" "" 2023:06:13:11:18:39;
	attributeDefinitions
		failureErrorMessage:           StringUtf8 subId = 3, number = 4, wsdlName = "failureErrorMessage", ordinal = 4;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:18:39.023;
		i3:                            Integer64 number = 2, wsdlName = "i3", ordinal = 2;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:18:39.022;
		logMessages:                   StringUtf8 subId = 2, number = 3, wsdlName = "logMessages", ordinal = 3;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:18:39.023;
		s5:                            StringUtf8 subId = 1, number = 1, wsdlName = "s5", ordinal = 1;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:18:39.017;
	jadeMethodDefinitions
		closeWindowsLike(
			winTitle: String; 
			winTitleClassHint: String): Integer updating, number = 1007;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:22:40.220;
		countWindowsLike(
			winTitle: String; 
			winTitleClassHint: String; 
			autoLog: Boolean; 
			showEntireForm: Boolean): Integer updating, number = 1008;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:22:49.250;
		demoAddNumbers(
			i1: Integer; 
			i2: Integer): Integer updating, number = 1009;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:22:59.594;
		demoConcat(
			s1: String; 
			s2: String): String updating, number = 1013;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:27:30.579;
		doApi(
			function: StringUtf8; 
			s1: StringUtf8; 
			s2: StringUtf8; 
			...
			s4: StringUtf8; 
			i1: Integer64; 
			i2: Integer64): Integer updating, number = 1006, wsdlName = "doApi";
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:22:30.377;
		failureErrorMessage(
			set_: Boolean; 
			value_: StringUtf8 io) updating, mapping, number = 1005;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:18:39.024;
		getDotNetTypeName(): String number = 1001;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:18:39.015;
		guiStepAction(
			winTitle: String; 
			winTitleClassHint: String; 
			keystrokes: String; 
			buttonCaption: String; 
			optionButton: Integer; 
			jadeMask: Integer): Integer updating, number = 1010;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:24:25.467;
		i3(
			set_: Boolean; 
			value_: Integer64 io) updating, mapping, number = 1003;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:18:39.022;
		logMessages(
			set_: Boolean; 
		...
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:18:39.019;
		takeScreenShot(fileName: String): Integer updating, number = 1011;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:24:37.787;
		uiInteraction(
			winTitle: String; 
			winTitleClassHint: String; 
			keystrokes: String; 
			buttonCaption: String): Integer updating, number = 1012;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:24:48.093;
	)
	...
	(
		setModifiedTimeStamp "cnwdm6" "22.0.03" 2024:05:01:12:51:28;
	)
	...
	jadeMethodDefinitions
		atcgBtnClickInit(uiParams: JadeDynamicObject) number = 1018;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:27:10:00:17.954;
		...
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:07:17:16:19:18.502;
...
`A persistent instance is used for capture, a transient instance is used for class file gen.`
	...
	attributeDefinitions
		...
		setModifiedTimeStamp "<unknown>" "6.2.16" 110 2009:11:04:11:00:19;
	referenceDefinitions
		api:                           AtcgAPI  number = 5, ordinal = 5;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:27:10:23:04.169;
	jadeMethodDefinitions
		create() updating, number = 1001;
		setModifiedTimeStamp "cnwdm6" "18.0.00" 1114 2023:06:13:11:30:41.123;
	...
	(
		setModifiedTimeStamp "cnwdm6" "22.0.03" 1114 2024:06:11:15:45:53.755;
	jadeMethodDefinitions
		showModal(): Integer updating, clientExecution, number = 1036;
		setModifiedTimeStamp "cnwdm6" "22.0.03" 1114 2024:06:11:15:48:47.508;
	)
	...
	jadeMethodDefinitions
		...
		atcgMayContainDateOrTime(): Boolean number = 1029;
...
closeWindowsLike
{
closeWindowsLike(winTitle,winTitleClassHint:String):Integer updating;

vars
	retCode:Integer;
begin
	retCode := doApi("CloseWindowsLike", winTitle.StringUtf8, winTitleClassHint.StringUtf8, null, null, 0, 0);
	app.atcgLogMessageTC("called " & method.qualifiedName & "(winTitle=" & winTitle & ", winTitleClassHint=" & winTitleClassHint & ")=" & retCode.String & ":" & CrLf & logMessages.String);
	return retCode;
end;
}
countWindowsLike
{
countWindowsLike(winTitle,winTitleClassHint:String; autoLog,showEntireForm:Boolean):Integer updating;

vars
	retCode:Integer;
	show:String;
begin
	if showEntireForm then
		show := "ShowEntireForm";
	endif;
	retCode := doApi("CountWindowsLike", winTitle.StringUtf8, winTitleClassHint.StringUtf8, show.StringUtf8, null, 0, 0);
	if autoLog then
		app.atcgLogMessageTC("called " & method.name & "(winTitle=" & winTitle & ", winTitleClassHint=" & winTitleClassHint & ", autoLog=true, showEntireForm=" & showEntireForm.String & ")=" & retCode.String & ":" & CrLf & logMessages.String);
	endif;
	return retCode;
end;
}
demoAddNumbers
{
demoAddNumbers(i1,i2:Integer):Integer updating;
//	sample interface method
vars
	retCode:Integer;
begin
	retCode := doApi("AddNumbers", null, null, null, null, i1.Integer64, i2.Integer64);
	app.atcgLogMessageTC("called " & method.name & "(i1=" & i1.String & ", i2=" & i2.String & ")=" & retCode.String & ":" & CrLf & logMessages.String);
	return i3.Integer;
end;
}
demoConcat
{
demoConcat(s1,s2:String):String updating;
//	sample interface method
vars
	retCode:Integer;
begin
	retCode := doApi("Concat", s1.StringUtf8, s2.StringUtf8, null, null, 0, 0);
	app.atcgLogMessageTC("called " & method.name & "(s1=" & s1 & ", s2=" & s2 & ")=" & retCode.String & ":" & CrLf & logMessages.String);
	return s5.String;
end;
}
doApi
{
doApi(function,s1,s2,s3,s4:StringUtf8; i1,i2:Integer64):Integer updating;

begin
	return jadeDotNetMethod('doApi', function, s1, s2, s3, s4, i1, i2).Integer;
end;
}
failureErrorMessage
{
failureErrorMessage(set_:Boolean; value_:StringUtf8 io) updating, mapping;

begin
	jadeDotNetField('failureErrorMessage', set_, value_); 
end;
}
getDotNetTypeName
{
getDotNetTypeName():String;
	...
	// This method was generated by the JADE .NET Import Wizard

	// Date: 13 June 2023

begin
	return 'AtcgCommon.AtcgAPI';
end;
}
guiStepAction
{
guiStepAction(winTitle,winTitleClassHint,keystrokes,buttonCaption:String; optionButton,jadeMask:Integer):Integer updating;

vars
	retCode:Integer;
begin
	retCode := doApi("GuiStepAction", winTitle.StringUtf8, winTitleClassHint.StringUtf8, keystrokes.StringUtf8, buttonCaption.StringUtf8, optionButton, jadeMask);
	app.atcgLogMessageTC("called " & method.qualifiedName & 
	"(winTitle=" & winTitle & 
	", winTitleClassHint=" & winTitleClassHint & 
	", keystrokes=" & keystrokes & 
	", buttonCaption=" & buttonCaption & 
	", optionButton=" & optionButton.String & 
	", jadeMask=" & jadeMask.String & 
	")=" & retCode.String & ":" & CrLf & logMessages.String);
	return retCode;
end;
}
i3
{
i3(set_:Boolean; value_:Integer64 io) updating, mapping;

begin
	jadeDotNetField('i3', set_, value_); 
end;
}
logMessages
{
logMessages(set_:Boolean; value_:StringUtf8 io) updating, mapping;

begin
	jadeDotNetField('logMessages', set_, value_); 
end;
}
s5
{
s5(set_:Boolean; value_:StringUtf8 io) updating, mapping;

begin
	jadeDotNetField('s5', set_, value_); 
end;
}
takeScreenShot
{
takeScreenShot(fileName:String):Integer updating;

vars
	retCode:Integer;
begin
	retCode := doApi("TakeScreenShot", fileName.StringUtf8, null, null, null, 0, 0);
	app.atcgLogMessageTC("called " & method.name & "(fileName=" & fileName & ")=" & retCode.String);
	return retCode;
end;
}
uiInteraction
{
uiInteraction(winTitle,winTitleClassHint,keystrokes,buttonCaption:String):Integer updating;

vars
	retCode:Integer;
begin
	retCode := doApi("UiInteraction", winTitle.StringUtf8, winTitleClassHint.StringUtf8, keystrokes.StringUtf8, buttonCaption.StringUtf8, 0, 0);
	app.atcgLogMessageTC("called " & method.qualifiedName & "(winTitle=" & winTitle & ", winTitleClassHint=" & winTitleClassHint & ", keystrokes=" & keystrokes & ", buttonCaption=" & buttonCaption & ")=" & retCode.String & ":" & CrLf & logMessages.String);
	return retCode;
end;
}
	)
...
atcgBtnClickInit
{
atcgBtnClickInit(uiParams:JadeDynamicObject);
...
vars
	...
	api:AtcgAPI;
begin
	wintitle := uiParams.getPropertyValue("wintitle").String;
	button := uiParams.getPropertyValue("button").String;
	app.atcgLogMessageTC("Running AtcgBtnClick for window '" & wintitle & "' with button '" & button&"'");
    
	create api transient;
	if api.uiInteraction(wintitle, "", "", button) = 0 then
		app.msgBox(app.name & " couldn't find wintitle and/or button", "ATCG Pause on Error Dialog", MsgBox_OK_Only);
	endif;
...
vars
	s:String;
begin
	if app.getProfileStringAppServer(app.getIniFileName, "JadeSecurity","MethodTrackingEnabled", null).toLower = true.String then
		app.atcgLogMessageG("MethodTrackingEnabled=true");
		return true;
	else 
		s:=" does not have MethodTrackingEnabled=true on app server so will terminate, as this is required";
